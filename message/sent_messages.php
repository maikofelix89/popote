    ...
    <div class="container">
        <div class="col-md-3" id="sidemenu">
            <ul class="nav nav-pills nav-stacked">
                <li ><a href="../message/view_message.php">Inbox</a></li>
                <li class="active"><a href="../message/sent_messages.php">Sent</a></li>
...
$sql2="SELECT * FROM `perm_user` WHERE perm_id='$recepient'";
...
while($row2=mysql_fetch_array($result2)){
    ...
    <div class='panel panel-info'>
                     <div class='panel-heading'>To :<a href='../user.php?user=".$recepient."'> ".$fname." ".$lname."</a><br></br>Time: ".$thedate."</div>
                     <div class='panel-body'>
                        ".$message."
                    </div>
                    <div class='panel-footer'><a href='#".$recepient."' data-toggle='modal' class='fa fa-pencil-square-o'> Reply </a>&nbsp;
    ...
    <div id=".$recepient." class='modal fade'>
